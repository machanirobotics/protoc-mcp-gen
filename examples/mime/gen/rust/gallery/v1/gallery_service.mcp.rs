...
const GALLERY_SERVICE__LIST_ASSETS_OUTPUT_SCHEMA_JSON: &str = r##"{"properties":{"assets":{"items":{"properties":{"id":{"description":"Identifier of the asset, e.g. \"overview\".","type":"string"},"mime_type":{"description":"IANA media type of the asset, e.g. \"text/markdown\".","examples":["text/markdown","image/png"],"type":"string"},"size_bytes":{"type":"string"},"title":{"type":"string"},"uri":{"description":"URI the asset is served from.","format":"uri","type":"string"}},"required":[],"type":"object"},"type":"array"}},"required":[],"type":"object"}"##;
...
impl<T: GalleryServiceMcpServer> GalleryServiceMcpHandler<T> {
    ...
    pub fn tools() -> Vec<Tool> {
        ...
        vec![
            make_tool_with_app_meta("get_asset", "Fetch a single asset's content and its media type.", GALLERY_SERVICE__GET_ASSET_SCHEMA_JSON, GALLERY_SERVICE__GET_ASSET_OUTPUT_SCHEMA_JSON, json!({"readOnlyHint": true, "idempotentHint": true, "openWorldHint": false
}), "", Value::Null, &app_uri),
            make_tool_with_app_meta("list_assets", "List gallery assets, optionally filtered by IANA media type.", GALLERY_SERVICE__LIST_ASSETS_SCHEMA_JSON, GALLERY_SERVICE__LIST_ASSETS_OUTPUT_SCHEMA_JSON, json!({"readOnlyHint": true, "idempotentHint": true, "openWorldHint": false
}), "List assets", json!([{"src": "https://example.com/icons/list.svg", "mimeType": "image/svg+xml", "theme": "light"}
]), &app_uri),
        ]
    }
